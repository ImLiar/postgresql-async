...
public abstract class Recycler<T> {
    ...
    static {
        ...
        // e.g. com.github.mauricio.netty.recycler.maxCapacity.writeTask
        //      com.github.mauricio.netty.recycler.maxCapacity.outboundBuffer
        int maxCapacity = SystemPropertyUtil.getInt("com.github.mauricio.netty.recycler.maxCapacity.default", 0);
        if (maxCapacity <= 0) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("-Dcom.github.mauricio.netty.recycler.maxCapacity.default: {}", DEFAULT_MAX_CAPACITY);
        }
