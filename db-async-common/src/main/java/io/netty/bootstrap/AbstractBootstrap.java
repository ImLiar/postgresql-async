...
/**
 * {@link io.netty.bootstrap.AbstractBootstrap} is a helper class that makes it easy to bootstrap a {@link io.netty.channel.Channel}. It support
 * method-chaining to provide an easy way to configure the {@link io.netty.bootstrap.AbstractBootstrap}.
 *
 * <p>When not used in a {@link io.netty.bootstrap.ServerBootstrap} context, the {@link #bind()} methods are useful for connectionless
...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
     ...
     * multiple {@link io.netty.channel.Channel}s with similar settings.  Please note that this method does not clone the
    ...
    /**
     * Create a new {@link io.netty.channel.Channel} and register it with an {@link EventLoop}.
     */
