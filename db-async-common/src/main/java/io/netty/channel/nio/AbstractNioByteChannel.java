...
public abstract class AbstractNioByteChannel extends AbstractNioChannel {
    ...
    /**
     * Read bytes into the given {@link io.netty.buffer.ByteBuf} and return the amount.
     */
    protected abstract int doReadBytes(ByteBuf buf) throws Exception;

    /**
     * Write bytes form the given {@link io.netty.buffer.ByteBuf} to the underlying {@link java.nio.channels.Channel}.
     * @param buf           the {@link io.netty.buffer.ByteBuf} from which the bytes should be written
     * @return amount       the amount of written bytes
     */
