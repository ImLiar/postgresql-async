...
/**
 * A region of a file that is sent via a {@link io.netty.channel.Channel} which supports
 ...
 * transfer, sending a file with {@link io.netty.channel.FileRegion} might fail or yield worse
 * performance.  For example, sending a large file doesn't work well in Windows.
 *
 * <h3>Not all transports support it</h3>
 *
 * Currently, the NIO transport is the only transport that supports {@link io.netty.channel.FileRegion}.
 */
