...
public final class ChannelOutboundBuffer {
    ...
    /**
     * Returns an array of direct NIO buffers if the currently pending messages are made of {@link io.netty.buffer.ByteBuf} only.
     ...
     * Refer to {@link io.netty.channel.socket.nio.NioSocketChannel#doWrite(io.netty.channel.ChannelOutboundBuffer)} for an example.
     * </p>
     */
