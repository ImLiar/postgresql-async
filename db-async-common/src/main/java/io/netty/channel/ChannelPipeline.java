 ...
 * {@link io.netty.channel.Channel}.  {@link io.netty.channel.ChannelPipeline} implements an advanced form of the
 ...
 *
 * The following diagram describes how I/O events are processed by {@link io.netty.channel.ChannelHandler}s in a {@link io.netty.channel.ChannelPipeline}
 ...
 * {@link io.netty.channel.ChannelHandlerContext}, such as {@link io.netty.channel.ChannelHandlerContext#fireChannelRead(Object)} and
 * {@link io.netty.channel.ChannelHandlerContext#write(Object)}.
 *
 * <pre>
 *                                                 I/O Request
 ...
 * When an event goes outbound, the order is 5, 4, 3, 2, 1.  On top of this principle, {@link io.netty.channel.ChannelPipeline} skips
 ...
 * <li>If 5 implements both {@link io.netty.channel.ChannelInboundHandler} and {@link io.netty.channel.ChannelOutboundHandler}, the evaluation order of
 ...
 * {@link io.netty.channel.ChannelHandlerContext} to forward an event to its next handler.  Those methods include:
 * <ul>
 * <li>Inbound event propagation methods:
 *     <ul>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#fireChannelRegistered()}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#fireChannelActive()}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#fireChannelRead(Object)}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#fireChannelReadComplete()}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#fireExceptionCaught(Throwable)}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#fireUserEventTriggered(Object)}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#fireChannelWritabilityChanged()}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#fireChannelInactive()}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#fireChannelUnregistered()}</li>
 *     </ul>
 * </li>
 * <li>Outbound event propagation methods:
 *     <ul>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#bind(java.net.SocketAddress, io.netty.channel.ChannelPromise)}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#connect(java.net.SocketAddress, java.net.SocketAddress, io.netty.channel.ChannelPromise)}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#write(Object, io.netty.channel.ChannelPromise)}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#flush()}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#read()}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#disconnect(io.netty.channel.ChannelPromise)}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#close(io.netty.channel.ChannelPromise)}</li>
 *     <li>{@link io.netty.channel.ChannelHandlerContext#deregister(io.netty.channel.ChannelPromise)}</li>
 *     </ul>
 * </li>
 * </ul>
 *
 ...
 *
 * <pre>
 * public class MyInboundHandler extends {@link io.netty.channel.ChannelInboundHandlerAdapter} {
 *     {@code @Override}
 *     public void channelActive({@link io.netty.channel.ChannelHandlerContext} ctx) {
 *         System.out.println("Connected!");
 *         ctx.fireChannelActive();
 *     }
 * }
 *
 * public clas MyOutboundHandler extends {@link io.netty.channel.ChannelOutboundHandlerAdapter} {
 *     {@code @Override}
 *     public void close({@link io.netty.channel.ChannelHandlerContext} ctx, {@link io.netty.channel.ChannelPromise} promise) {
 ...
 *
 * <pre>
 * static final {@link io.netty.util.concurrent.EventExecutorGroup} group = new {@link io.netty.util.concurrent.DefaultEventExecutorGroup}(16);
 * ...
 *
 * {@link io.netty.channel.ChannelPipeline} pipeline = ch.pipeline();
 *
 ...
 * <h3>Thread safety</h3>
 * <p>
 * A {@link io.netty.channel.ChannelHandler} can be added or removed at any time because a {@link io.netty.channel.ChannelPipeline} is thread safe.
...
public interface ChannelPipeline
    ...
    /**
     * Inserts a {@link io.netty.channel.ChannelHandler}s at the first position of this pipeline.
     *
     ...
     * Inserts a {@link io.netty.channel.ChannelHandler}s at the first position of this pipeline.
     *
     * @param group     the {@link io.netty.util.concurrent.EventExecutorGroup} which will be used to execute the {@link io.netty.channel.ChannelHandler}s
     *                  methods.
     * @param handlers  the handlers to insert first
     *
     */
    ...
    /**
     * Inserts a {@link io.netty.channel.ChannelHandler}s at the last position of this pipeline.
     *
    ...
    /**
     * A {@link io.netty.channel.Channel} was registered to its {@link io.netty.channel.EventLoop}.
     *
    ...
    /**
     * A {@link io.netty.channel.Channel} was unregistered from its {@link io.netty.channel.EventLoop}.
     *
     ...
     * a {@link io.netty.channel.ConnectTimeoutException}. If it fails because of connection refused a {@link java.net.ConnectException}
     * will be used.
     * <p>
     * This will result in having the
    ...
    /**
     * Request to deregister the {@link io.netty.channel.Channel} from the previous assigned {@link io.netty.util.concurrent.EventExecutor} and notify the
     * {@link io.netty.channel.ChannelFuture} once the operation completes, either because the operation was successful or because of
     * an error.
     * <p>
     * This will result in having the
    ...
    /**
     * Request to close the {@link io.netty.channel.Channel} bound to this {@link io.netty.channel.ChannelPipeline} and notify the {@link io.netty.channel.ChannelFuture}
    ...
    /**
     * Request to deregister the {@link io.netty.channel.Channel} bound this {@link io.netty.channel.ChannelPipeline} from the previous assigned
     * {@link io.netty.util.concurrent.EventExecutor} and notify the {@link io.netty.channel.ChannelFuture} once the operation completes, either because the
    ...
    /**
     * Request to write a message via this {@link io.netty.channel.ChannelPipeline}.
