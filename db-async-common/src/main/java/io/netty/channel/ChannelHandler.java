 ...
 * <h3>Sub-types</h3>
 * <p>
 * {@link io.netty.channel.ChannelHandler} itself does not provide many methods.  To handle a
 ...
 * <li>{@link io.netty.channel.ChannelOutboundHandlerAdapter} handles and intercepts outbound operations</li>
 * </ul>
 *
 ...
 * <p>
 * A {@link io.netty.channel.ChannelHandler} is provided with a {@link io.netty.channel.ChannelHandlerContext}
 * object.  A {@link io.netty.channel.ChannelHandler} is supposed to interact with the
 * {@link ChannelPipeline} it belongs to via a context object.  Using the
 * context object, the {@link io.netty.channel.ChannelHandler} can pass events upstream or
 * downstream, modify the pipeline dynamically, or store the information
 * (attachment) which is specific to the handler.
 *
 * <h3>State management</h3>
 *
 * A {@link io.netty.channel.ChannelHandler} often needs to store some stateful information.
 ...
 * }
 *
 * public class DataServerHandler extends {@link io.netty.channel.SimpleChannelInboundHandler}&lt;Message&gt; {
 *
 *     <b>private boolean loggedIn;</b>
 *
 *     {@code @Override}
 *     public void channelRead({@link io.netty.channel.ChannelHandlerContext} ctx, Message message) {
 *         {@link io.netty.channel.Channel} ch = e.getChannel();
 ...
 * // See {@link ChannelInitializer#initChannel(io.netty.channel.Channel)}.
 * public class DataServerInitializer extends {@link ChannelInitializer}&lt{@link io.netty.channel.Channel}&gt {
 *     {@code @Override}
 ...
 * {@code @Sharable}
 * public class DataServerHandler extends {@link io.netty.channel.SimpleChannelInboundHandler}&lt;Message&gt; {
 *   private final {@link io.netty.util.AttributeKey}&lt{@link Boolean}&gt auth =
 *           new {@link io.netty.util.AttributeKey}&lt{@link Boolean}&gt("auth");
 *
 *   // This handler will receive a sequence of increasing integers starting
 *   // from 1.
 *   {@code @Override}
 *   public void channelRead({@link io.netty.channel.ChannelHandlerContext} ctx, {@link Integer} integer) {
 *     {@link io.netty.util.Attribute}&lt{@link Boolean}&gt attr = ctx.getAttr(auth);
 *
 *     {@code @Override}
 *     public void channelRead({@link io.netty.channel.ChannelHandlerContext} ctx, Message message) {
 *         {@link io.netty.channel.Channel} ch = ctx.channel();
 *         if (message instanceof LoginMessage) {
 ...
 * <p>
 * If a {@link io.netty.channel.ChannelHandler} is annotated with the {@code @Sharable}
