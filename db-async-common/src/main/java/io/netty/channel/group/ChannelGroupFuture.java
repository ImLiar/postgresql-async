...
/**
 * The result of an asynchronous {@link io.netty.channel.group.ChannelGroup} operation.
 * {@link io.netty.channel.group.ChannelGroupFuture} is composed of {@link io.netty.channel.ChannelFuture}s which
 * represent the outcome of the individual I/O operations that affect the
 * {@link io.netty.channel.Channel}s in the {@link io.netty.channel.group.ChannelGroup}.
 *
 * <p>
 * All I/O operations in {@link io.netty.channel.group.ChannelGroup} are asynchronous.  It means any
 ...
 * returned with a {@link io.netty.channel.group.ChannelGroupFuture} instance which tells you when the
 ...
 *
 * <h3>Prefer {@link #addListener(io.netty.util.concurrent.GenericFutureListener)} to {@link #await()}</h3>
 *
 * It is recommended to prefer {@link #addListener(io.netty.util.concurrent.GenericFutureListener)} to
 * {@link #await()} wherever possible to get notified when I/O operations are
 * done and to do any follow-up tasks.
 * <p>
 * {@link #addListener(io.netty.util.concurrent.GenericFutureListener)} is non-blocking.  It simply
 * adds the specified {@link ChannelGroupFutureListener} to the
 * {@link io.netty.channel.group.ChannelGroupFuture}, and I/O thread will notify the listeners when
 ...
 *     {@link io.netty.channel.group.ChannelGroup} allChannels = MyServer.getAllChannels();
 *     {@link io.netty.channel.group.ChannelGroupFuture} future = allChannels.close();
 ...
 *         public void operationComplete({@link io.netty.channel.group.ChannelGroupFuture} future) {
...
public interface ChannelGroupFuture extends Future<Void>, Iterable<ChannelFuture> {
    ...
    /**
     * Returns the {@link io.netty.channel.group.ChannelGroup} which is associated with this future.
     */
    ChannelGroup group();
    ...
    /**
     * Returns the {@link java.util.Iterator} that enumerates all {@link io.netty.channel.ChannelFuture}s
     * which are associated with this future.  Please note that the returned
     * {@link java.util.Iterator} is is unmodifiable, which means a {@link io.netty.channel.ChannelFuture}
