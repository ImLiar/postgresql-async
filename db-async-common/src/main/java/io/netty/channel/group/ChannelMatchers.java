...
/**
 * Helper class which provides often used {@link io.netty.channel.group.ChannelMatcher} implementations.
 */
public final class ChannelMatchers {
    ...
    /**
     * Returns a {@link io.netty.channel.group.ChannelMatcher} that matches all {@link io.netty.channel.Channel}s.
     */
    ...
    /**
     * Returns a {@link io.netty.channel.group.ChannelMatcher} that matches all {@link io.netty.channel.Channel}s except the given.
     */
    ...
    /**
     * Returns a {@link io.netty.channel.group.ChannelMatcher} that matches the given {@link io.netty.channel.Channel}.
     */
    ...
    /**
     * Returns a {@link io.netty.channel.group.ChannelMatcher} that matches all {@link io.netty.channel.Channel}s that are an instance of sub-type of
     * the given class.
     */
    ...
    /**
     * Returns a {@link io.netty.channel.group.ChannelMatcher} that matches all {@link io.netty.channel.Channel}s that are <strong>not</strong> an
    ...
    /**
     * Returns a {@link io.netty.channel.group.ChannelMatcher} that matches all {@link io.netty.channel.Channel}s that are of type {@link io.netty.channel.ServerChannel}.
     */
    ...
    /**
     * Returns a {@link io.netty.channel.group.ChannelMatcher} that matches all {@link io.netty.channel.Channel}s that are <strong>not</strong> of type
     * {@link io.netty.channel.ServerChannel}.
     */
    ...
    /**
     * Invert the given {@link io.netty.channel.group.ChannelMatcher}.
     */
    ...
    /**
     * Return a composite of the given {@link io.netty.channel.group.ChannelMatcher}s. This means all {@link io.netty.channel.group.ChannelMatcher} must
