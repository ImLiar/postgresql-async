 ...
 * various bulk operations on them.  Using {@link io.netty.channel.group.ChannelGroup}, you can
 ...
 * {@link io.netty.channel.group.ChannelGroup}.
 *
 ...
 * add the {@link Channel}s associated with the recipients and call {@link io.netty.channel.group.ChannelGroup#write(Object)}:
 * <pre>
 * <strong>{@link io.netty.channel.group.ChannelGroup} recipients =
 *         new {@link io.netty.channel.group.DefaultChannelGroup}({@link io.netty.util.concurrent.GlobalEventExecutor}.INSTANCE);</strong>
 * recipients.add(channelA);
 * recipients.add(channelB);
 * ..
 * <strong>recipients.write({@link io.netty.buffer.Unpooled}.copiedBuffer(
 *         "Service will shut down for maintenance in 5 minutes.",
 *         {@link io.netty.util.CharsetUtil}.UTF_8));</strong>
 * </pre>
 *
 * <h3>Simplify shutdown process with {@link io.netty.channel.group.ChannelGroup}</h3>
 * <p>
 * If both {@link ServerChannel}s and non-{@link ServerChannel}s exist in the
 * same {@link io.netty.channel.group.ChannelGroup}, any requested I/O operations on the group are
 ...
 *
 * <pre>
 * <strong>{@link io.netty.channel.group.ChannelGroup} allChannels =
 *         new {@link io.netty.channel.group.DefaultChannelGroup}({@link io.netty.util.concurrent.GlobalEventExecutor}.INSTANCE);</strong>
 *
...
public interface ChannelGroup extends Set<Channel>, Comparable<ChannelGroup> {
     ...
     * {@link io.netty.buffer.ByteBuf}, it is automatically
     * {@linkplain io.netty.buffer.ByteBuf#duplicate() duplicated} to avoid a race
     * condition. The same is true for {@link io.netty.buffer.ByteBufHolder}. Please note that this operation is asynchronous as
