...
public class DefaultChannelGroup extends AbstractSet<Channel> implements ChannelGroup {
    ...
    /**
     * Creates a new group with a generated name amd the provided {@link io.netty.util.concurrent.EventExecutor} to notify the
    ...
    /**
     * Creates a new group with the specified {@code name} and {@link io.netty.util.concurrent.EventExecutor} to notify the
