...
/**
 * {@link ChannelException} which holds {@link io.netty.channel.ChannelFuture}s that failed because of an error.
 */
public class ChannelGroupException extends ChannelException implements Iterable<Map.Entry<Channel, Throwable>> {
     ...
     * related id of the {@link io.netty.channel.Channel}.
     */
    @Override
