...
public abstract class AbstractOioByteChannel extends AbstractOioChannel {
    ...
    /**
     * @see io.netty.channel.oio.AbstractOioByteChannel#AbstractOioByteChannel(io.netty.channel.Channel)
     */
     ...
     *
     * @param buf           the {@link io.netty.buffer.ByteBuf} into which the read bytes will be written
    ...
    /**
     * Write the data which is hold by the {@link io.netty.buffer.ByteBuf} to the underlying Socket.
     *
     * @param buf           the {@link io.netty.buffer.ByteBuf} which holds the data to transfer
     * @throws Exception    is thrown if an error occurred
     */
