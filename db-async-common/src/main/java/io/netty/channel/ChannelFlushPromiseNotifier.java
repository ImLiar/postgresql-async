...
public final class ChannelFlushPromiseNotifier {
    ...
    /**
     * Add a {@link io.netty.channel.ChannelPromise} to this {@link io.netty.channel.ChannelFlushPromiseNotifier} which will be notified after the given
    ...
    /**
     * Return the current write counter of this {@link io.netty.channel.ChannelFlushPromiseNotifier}
     */
     ...
     *
     * After a {@link io.netty.channel.ChannelFuture} was notified it will be removed from this {@link io.netty.channel.ChannelFlushPromiseNotifier} and
     ...
     *
     * So after this operation this {@link io.netty.channel.ChannelFutureListener} is empty.
     */
     ...
     * So after this operation this {@link io.netty.channel.ChannelFutureListener} is empty.
     *
     * @param cause1    the {@link Throwable} which will be used to fail all of the {@link io.netty.channel.ChannelFuture}s whichs
     *                  pendingDataSize is smaller then the current writeCounter returned by {@link #writeCounter()}
     * @param cause2    the {@link Throwable} which will be used to fail the remaining {@link io.netty.channel.ChannelFuture}s
     */
