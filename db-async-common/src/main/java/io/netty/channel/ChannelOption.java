...
/**
 * A {@link io.netty.channel.ChannelOption} allows to configure a {@link ChannelConfig} in a type-safe
...
public class ChannelOption<T> extends UniqueName {
     ...
     *
     * {@code true} if and only if the {@link io.netty.channel.Channel} is closed automatically and immediately on write failure.
    ...
    /**
     * Creates a new {@link io.netty.channel.ChannelOption} with the specified {@code name}.
     */
