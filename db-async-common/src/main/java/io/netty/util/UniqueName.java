...
public class UniqueName implements Comparable<UniqueName> {
    ...
    /**
     * Constructs a new {@link io.netty.util.UniqueName}
     *
     * @param map the map of names to compare with
     * @param name the name of this {@link io.netty.util.UniqueName}
    ...
    /**
     * Returns this {@link io.netty.util.UniqueName}'s name
     *
     * @return the name
     */
    ...
    /**
     * Returns this {@link io.netty.util.UniqueName}'s ID
     *
     * @return the id
     */
    public final int id() {
