...
public interface Attribute<T> {
    ...
    /**
     *  Atomically sets to the given value if this {@link io.netty.util.Attribute} does not contain a value at the moment.
     *  If it was not possible to set the value as it contains a value it will just return the current value.
     */
    T setIfAbsent(T value);

    /**
     * Removes this attribute from the {@link io.netty.util.AttributeMap} and returns the old value..  Subsequent {@link #get()}
    ...
    /**
     * Removes this attribute from the {@link io.netty.util.AttributeMap}.  Subsequent {@link #get()} calls will return @{code null}.
     */
    void remove();
}
