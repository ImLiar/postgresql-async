...
/**
 * A {@link io.netty.util.Timer} optimized for approximated I/O timeout scheduling.
 *
 * <h3>Tick Duration</h3>
 *
 * As described with 'approximated', this timer does not execute the scheduled
 * {@link io.netty.util.TimerTask} on time.  {@link io.netty.util.HashedWheelTimer}, on every tick, will
 * check if there are any {@link io.netty.util.TimerTask}s behind the schedule and execute
 * them.
 * <p>
 ...
 *
 * {@link io.netty.util.HashedWheelTimer} maintains a data structure called 'wheel'.
 * To put simply, a wheel is a hash table of {@link io.netty.util.TimerTask}s whose hash
 ...
 *
 * {@link io.netty.util.HashedWheelTimer} creates a new thread whenever it is instantiated and
 ...
 *
 * {@link io.netty.util.HashedWheelTimer} is based on
