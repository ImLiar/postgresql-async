...
public final class ResourceLeakDetector<T> {
    ...
    /**
     * @deprecated Use {@link #setLevel(io.netty.util.ResourceLeakDetector.Level)} instead.
     */
    @Deprecated
    ...
    /**
     * Creates a new {@link io.netty.util.ResourceLeak} which is expected to be closed via {@link io.netty.util.ResourceLeak#close()} when the
     * related resource is deallocated.
     *
     * @return the {@link io.netty.util.ResourceLeak} or {@code null}
     */
