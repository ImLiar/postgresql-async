...
/**
 * Collection of method to handle objects that may implement {@link io.netty.util.ReferenceCounted}.
 */
public final class ReferenceCountUtil {
    ...
    /**
     * Try to call {@link io.netty.util.ReferenceCounted#retain()} if the specified message implements {@link io.netty.util.ReferenceCounted}.
     * If the specified message doesn't implement {@link io.netty.util.ReferenceCounted}, this method does nothing.
     */
    ...
    /**
     * Try to call {@link io.netty.util.ReferenceCounted#release()} if the specified message implements {@link io.netty.util.ReferenceCounted}.
     * If the specified message doesn't implement {@link io.netty.util.ReferenceCounted}, this method does nothing.
     */
