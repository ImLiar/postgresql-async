...
public class DefaultProgressivePromise<V> extends DefaultPromise<V> implements ProgressivePromise<V> {
     ...
     *
     * It is preferable to use {@link io.netty.util.concurrent.EventExecutor#newProgressivePromise()} to create a new progressive promise
     *
     * @param executor
     *        the {@link io.netty.util.concurrent.EventExecutor} which is used to notify the promise when it progresses or it is complete
     */
