...
/**
 * Special {@link io.netty.util.concurrent.ProgressiveFuture} which is writable.
 */
public interface ProgressivePromise<V> extends Promise<V>, ProgressiveFuture<V> {
     ...
     * {@link io.netty.util.concurrent.GenericProgressiveFutureListener}.  If the operation is already complete or the progress is out of range,
