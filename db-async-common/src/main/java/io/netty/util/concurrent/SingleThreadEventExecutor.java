...
/**
 * Abstract base class for {@link io.netty.util.concurrent.EventExecutor}'s that execute all its submitted tasks in a single thread.
 *
 */
public abstract class SingleThreadEventExecutor extends AbstractEventExecutor {
     ...
     *
     * @param parent            the {@link io.netty.util.concurrent.EventExecutorGroup} which is the parent of this instance and belongs to it
     ...
     * {@link java.util.concurrent.LinkedBlockingQueue} but if your sub-class of {@link io.netty.util.concurrent.SingleThreadEventExecutor} will not do any blocking
