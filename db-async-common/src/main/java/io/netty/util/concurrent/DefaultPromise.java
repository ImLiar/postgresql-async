...
public class DefaultPromise<V> extends AbstractFuture<V> implements Promise<V> {
     ...
     *
     * It is preferable to use {@link io.netty.util.concurrent.EventExecutor#newPromise()} to create a new promise
     *
     * @param executor
     *        the {@link io.netty.util.concurrent.EventExecutor} which is used to notify the promise once it is complete
     */
    ...
    /**
     * Returns a {@link io.netty.util.concurrent.GenericProgressiveFutureListener}, an array of {@link io.netty.util.concurrent.GenericProgressiveFutureListener}, or
     * {@code null}.
     */
