...
/**
 * Skeletal {@link io.netty.buffer.ByteBufAllocator} implementation to extend.
 */
public abstract class AbstractByteBufAllocator implements ByteBufAllocator {
    ...
    /**
     * Create a heap {@link io.netty.buffer.ByteBuf} with the given initialCapacity and maxCapacity.
     */
    protected abstract ByteBuf newHeapBuffer(int initialCapacity, int maxCapacity);

    /**
     * Create a direct {@link io.netty.buffer.ByteBuf} with the given initialCapacity and maxCapacity.
     */
