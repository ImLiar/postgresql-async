...
/**
 * Creates a new {@link io.netty.buffer.ByteBuf} by allocating new space or by wrapping
 ...
 *
 * <pre>
 * import static io.netty.buffer.{@link io.netty.buffer.Unpooled}.*;
 *
 * {@link io.netty.buffer.ByteBuf} heapBuffer    = buffer(128);
 * {@link io.netty.buffer.ByteBuf} directBuffer  = directBuffer(256);
 * {@link io.netty.buffer.ByteBuf} wrappedBuffer = wrappedBuffer(new byte[128], new byte[256]);
 * {@link io.netty.buffer.ByteBuf} copiedBuffe r = copiedBuffer({@link java.nio.ByteBuffer}.allocate(128));
 * </pre>
 *
...
public final class Unpooled {
    ...
    /**
     * Return a unreleasable view on the given {@link io.netty.buffer.ByteBuf} which will just ignore release and retain calls.
     */
