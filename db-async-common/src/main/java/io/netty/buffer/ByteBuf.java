 ...
 * <h4>NIO Buffers</h4>
 *
 * If a {@link io.netty.buffer.ByteBuf} can be converted into an NIO {@link java.nio.ByteBuffer} which shares its
 * content (i.e. view buffer), you can get it via the {@link #nioBuffer()} method.  To determine
 * if a buffer can be converted into an NIO buffer, use {@link #nioBufferCount()}.
 *
 * <h4>Strings</h4>
 *
 * Various {@link #toString(java.nio.charset.Charset)} methods convert a {@link io.netty.buffer.ByteBuf}
...
public abstract class ByteBuf implements ReferenceCounted, Comparable<ByteBuf> {
     ...
     * {@link io.netty.buffer.ByteBuf} buf = {@link Unpooled}.buffer(8);
     *
     ...
     * {@link io.netty.buffer.ByteBuf} buf = {@link Unpooled}.wrappedBuffer(new byte[8]);
     *
