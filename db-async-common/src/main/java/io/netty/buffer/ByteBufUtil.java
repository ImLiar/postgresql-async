...
/**
 * A collection of utility methods that is related with handling {@link io.netty.buffer.ByteBuf}.
 */
public final class ByteBufUtil {
    ...
    /**
     * Compares the two specified buffers as described in {@link io.netty.buffer.ByteBuf#compareTo(io.netty.buffer.ByteBuf)}.
     * This method is useful when implementing a new buffer type.
     */
    ...
    /**
     * The default implementation of {@link io.netty.buffer.ByteBuf#indexOf(int, int, byte)}.
     * This method is useful when implementing a new buffer type.
     */
    ...
    /**
     * Read the given amount of bytes into a new {@link io.netty.buffer.ByteBuf} that is allocated from the {@link ByteBufAllocator}.
     */
    ...
    /**
     * Encode the given {@link java.nio.CharBuffer} using the given {@link java.nio.charset.Charset} into a new {@link io.netty.buffer.ByteBuf} which
