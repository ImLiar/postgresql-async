 ...
 * {@link ByteBufAllocator#compositeBuffer()} or {@link io.netty.buffer.Unpooled#wrappedBuffer(io.netty.buffer.ByteBuf...)} instead of calling the
...
public class CompositeByteBuf extends AbstractReferenceCountedByteBuf {
    ...
    /**
     * Add the given {@link io.netty.buffer.ByteBuf}.
     *
     * Be aware that this method does not increase the {@code writerIndex} of the {@link io.netty.buffer.CompositeByteBuf}.
     * If you need to have it increased you need to handle it by your own.
     *
     * @param buffer the {@link io.netty.buffer.ByteBuf} to add
     */
    ...
    /**
     * Add the given {@link io.netty.buffer.ByteBuf}s.
     *
     * Be aware that this method does not increase the {@code writerIndex} of the {@link io.netty.buffer.CompositeByteBuf}.
     * If you need to have it increased you need to handle it by your own.
     *
     * @param buffers the {@link io.netty.buffer.ByteBuf}s to add
     */
    ...
    /**
     * Add the given {@link io.netty.buffer.ByteBuf} on the specific index.
     *
     * Be aware that this method does not increase the {@code writerIndex} of the {@link io.netty.buffer.CompositeByteBuf}.
     * If you need to have it increased you need to handle it by your own.
     *
     * @param cIndex the index on which the {@link io.netty.buffer.ByteBuf} will be added
     * @param buffer the {@link io.netty.buffer.ByteBuf} to add
     */
    ...
    /**
     * Add the given {@link io.netty.buffer.ByteBuf}s on the specific index
     *
     * Be aware that this method does not increase the {@code writerIndex} of the {@link io.netty.buffer.CompositeByteBuf}.
     * If you need to have it increased you need to handle it by your own.
     *
    ...
    /**
     * Remove the {@link io.netty.buffer.ByteBuf} from the given index.
     *
     * @param cIndex the index on from which the {@link io.netty.buffer.ByteBuf} will be remove
     */
    ...
    /**
     * Remove the number of {@link io.netty.buffer.ByteBuf}s starting from the given index.
     *
     * @param cIndex the index on which the {@link io.netty.buffer.ByteBuf}s will be started to removed
    ...
    /**
     * Return the current number of {@link io.netty.buffer.ByteBuf}'s that are composed in this instance
     */
    ...
    /**
     * Return the max number of {@link io.netty.buffer.ByteBuf}'s that are composed in this instance
     */
    ...
    /**
     * Return the {@link io.netty.buffer.ByteBuf} on the specified index
     *
     * @param cIndex the index for which the {@link io.netty.buffer.ByteBuf} should be returned
     * @return buf the {@link io.netty.buffer.ByteBuf} on the specified index
     */
     ...
     * Return the {@link io.netty.buffer.ByteBuf} on the specified index
     *
     * @param offset the offset for which the {@link io.netty.buffer.ByteBuf} should be returned
     * @return the {@link io.netty.buffer.ByteBuf} on the specified index
     */
    ...
    /**
     * Return the internal {@link io.netty.buffer.ByteBuf} on the specified index. Note that updating the indexes of the returned
    ...
    /**
     * Return the internal {@link io.netty.buffer.ByteBuf} on the specified offset. Note that updating the indexes of the returned
     * buffer will lead to an undefined behavior of this buffer.
     *
     * @param offset the offset for which the {@link io.netty.buffer.ByteBuf} should be returned
     */
    ...
    /**
     * Consolidate the composed {@link io.netty.buffer.ByteBuf}s
     */
    ...
    /**
     * Discard all {@link io.netty.buffer.ByteBuf}s which are read.
     */
