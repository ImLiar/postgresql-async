...
/**
 * A NIO {@link java.nio.ByteBuffer} based buffer.  It is recommended to use {@link io.netty.buffer.Unpooled#directBuffer(int)}
 * and {@link io.netty.buffer.Unpooled#wrappedBuffer(java.nio.ByteBuffer)} instead of calling the
