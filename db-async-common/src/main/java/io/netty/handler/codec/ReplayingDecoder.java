...
/**
 * A specialized variation of {@link io.netty.handler.codec.ByteToMessageDecoder} which enables implementation
 * of a non-blocking decoder in the blocking I/O paradigm.
 * <p>
 * The biggest difference between {@link io.netty.handler.codec.ReplayingDecoder} and
 * {@link io.netty.handler.codec.ByteToMessageDecoder} is that {@link io.netty.handler.codec.ReplayingDecoder} allows you to
 ...
 * {@link io.netty.handler.codec.ByteToMessageDecoder} implementation:
 * <pre>
 * public class IntegerHeaderFrameDecoder extends {@link io.netty.handler.codec.ByteToMessageDecoder} {
 *
 *   {@code @Override}
 *   protected void decode({@link io.netty.channel.ChannelHandlerContext} ctx,
 *                           {@link io.netty.buffer.ByteBuf} in, List&lt;Object&gt; out) throws Exception {
 *
 ...
 * }
 * </pre>
 * is simplified like the following with {@link io.netty.handler.codec.ReplayingDecoder}:
 * <pre>
 * public class IntegerHeaderFrameDecoder
 *      extends {@link io.netty.handler.codec.ReplayingDecoder}&lt;{@link Void}&gt; {
 *
 *   protected void decode({@link io.netty.channel.ChannelHandlerContext} ctx,
 *                           {@link io.netty.buffer.ByteBuf} buf) throws Exception {
 *
 ...
 * <p>
 * {@link io.netty.handler.codec.ReplayingDecoder} passes a specialized {@link io.netty.buffer.ByteBuf}
 ...
 * {@link io.netty.handler.codec.ReplayingDecoder}.  If {@link io.netty.handler.codec.ReplayingDecoder} catches the
 ...
 * buffer.
 * <p>
 * Please note that {@link io.netty.handler.codec.ReplayingDecoder} always throws the same cached
 * {@link Error} instance to avoid the overhead of creating a new {@link Error}
 * and filling its stack trace for every throw.
 *
 * <h3>Limitations</h3>
 * <p>
 * At the cost of the simplicity, {@link io.netty.handler.codec.ReplayingDecoder} enforces you a few
 * limitations:
 * <ul>
 ...
 *     not work:
 * <pre> public class MyDecoder extends {@link io.netty.handler.codec.ReplayingDecoder}&lt;{@link Void}&gt; {
 *
 *   private final Queue&lt;Integer&gt; values = new LinkedList&lt;Integer&gt;();
 *
 *   {@code @Override}
 *   public void decode(.., {@link io.netty.buffer.ByteBuf} in, List&lt;Object&gt; out) throws Exception {
 *
 ...
 *
 *   {@code @Override}
 *   public void decode(.., {@link io.netty.buffer.ByteBuf} buffer, List&lt;Object&gt; out) throws Exception {
 *
 ...
 * that {@link io.netty.handler.codec.ReplayingDecoder} rewinds the {@code readerIndex} of the buffer
 ...
 *
 * public class IntegerHeaderFrameDecoder
 *      extends {@link io.netty.handler.codec.ReplayingDecoder}&lt;<strong>MyDecoderState</strong>&gt; {
 *
 *   private int length;
 *
 ...
 * <pre>
 * public class IntegerHeaderFrameDecoder
 *      extends {@link io.netty.handler.codec.ReplayingDecoder}&lt;<strong>{@link Void}</strong>&gt; {
 *
 ...
 * replace a {@link io.netty.handler.codec.ReplayingDecoder} (protocol detector) with another
 * {@link io.netty.handler.codec.ReplayingDecoder}, {@link io.netty.handler.codec.ByteToMessageDecoder} or {@link io.netty.handler.codec.MessageToMessageDecoder}
 * (actual protocol decoder).
 * It is not possible to achieve this simply by calling
 * {@link io.netty.channel.ChannelPipeline#replace(io.netty.channel.ChannelHandler, String, io.netty.channel.ChannelHandler)}, but
 * some additional steps are required:
 * <pre>
 * public class FirstDecoder extends {@link io.netty.handler.codec.ReplayingDecoder}&lt;{@link Void}&gt; {
 *
 *     {@code @Override}
 *     protected Object decode({@link io.netty.channel.ChannelHandlerContext} ctx,
 *                             {@link io.netty.buffer.ByteBuf} in, List&lt;Object&gt; out) {
 *         ...
