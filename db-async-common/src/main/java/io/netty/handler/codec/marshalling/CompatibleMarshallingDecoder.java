...
/**
 * {@link io.netty.handler.codec.ReplayingDecoder} which use an {@link Unmarshaller} to read the Object out of the {@link io.netty.buffer.ByteBuf}.
 *
...
public class CompatibleMarshallingDecoder extends ReplayingDecoder<Void> {
    ...
    /**
     * Create a new instance of {@link io.netty.handler.codec.marshalling.CompatibleMarshallingDecoder}.
     *
     * @param provider
     *        the {@link io.netty.handler.codec.marshalling.UnmarshallerProvider} which is used to obtain the {@link Unmarshaller}
     *        for the {@link io.netty.channel.Channel}
     * @param maxObjectSize
     *        the maximal size (in bytes) of the {@link Object} to unmarshal. Once the size is
     *        exceeded the {@link io.netty.channel.Channel} will get closed. Use a a maxObjectSize of
