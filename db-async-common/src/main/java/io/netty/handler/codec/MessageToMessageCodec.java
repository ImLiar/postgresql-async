 ...
 *
 * This can be thought of as a combination of {@link io.netty.handler.codec.MessageToMessageDecoder} and {@link io.netty.handler.codec.MessageToMessageEncoder}.
 *
 * Here is an example of a {@link io.netty.handler.codec.MessageToMessageCodec} which just decode from {@link Integer} to {@link Long}
 * and encode from {@link Long} to {@link Integer}.
 *
 * <pre>
 *     public class NumberCodec extends
 *             {@link io.netty.handler.codec.MessageToMessageCodec}&lt;{@link Integer}, {@link Long}&gt; {
 *         {@code @Override}
 *         public {@link Long} decode({@link io.netty.channel.ChannelHandlerContext} ctx, {@link Integer} msg, List&lt;Object&gt; out)
 *                 throws {@link Exception} {
 *             out.add(msg.longValue());
 *         }
 *
 *         {@code @Overrride}
 *         public {@link Integer} encode({@link io.netty.channel.ChannelHandlerContext} ctx, {@link Long} msg, List&lt;Object&gt; out)
 *                 throws {@link Exception} {
 ...
 * are of type {@link io.netty.util.ReferenceCounted}. This is needed as the {@link io.netty.handler.codec.MessageToMessageCodec} will call
 * {@link io.netty.util.ReferenceCounted#release()} on encoded / decoded messages.
 */
public abstract class MessageToMessageCodec<INBOUND_IN, OUTBOUND_IN> extends ChannelDuplexHandler {
    ...
    /**
     * @see io.netty.handler.codec.MessageToMessageEncoder#encode(io.netty.channel.ChannelHandlerContext, Object, java.util.List)
     */
    protected abstract void encode(ChannelHandlerContext ctx, OUTBOUND_IN msg, List<Object> out)
            throws Exception;

    /**
     * @see io.netty.handler.codec.MessageToMessageDecoder#decode(io.netty.channel.ChannelHandlerContext, Object, java.util.List)
     */
