 ...
 * {@link io.netty.channel.ChannelHandlerContext} via the {@link io.netty.channel.ChannelHandlerContext#attr(io.netty.util.AttributeKey)}
 * method. So the same {@link Unmarshaller} will be used during the life-time of a {@link io.netty.channel.Channel}
 * for the {@link io.netty.channel.ChannelHandler}'s {@link io.netty.channel.ChannelHandlerContext}.
 *
 *
 */
