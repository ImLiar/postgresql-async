...
public class JZlibEncoder extends ZlibEncoder {
     ...
     * and the default wrapper ({@link io.netty.handler.codec.compression.ZlibWrapper#ZLIB}).
     *
     ...
     * {@link io.netty.handler.codec.compression.ZlibWrapper#ZLIB} because it is the only format that supports
