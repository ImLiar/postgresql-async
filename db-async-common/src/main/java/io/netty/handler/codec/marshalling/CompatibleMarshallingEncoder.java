...
public class CompatibleMarshallingEncoder extends MessageToByteEncoder<Object> {
    ...
    /**
     * Create a new instance of the {@link io.netty.handler.codec.marshalling.CompatibleMarshallingEncoder}
     *
     * @param provider  the {@link MarshallerProvider} to use to get the {@link Marshaller} for a {@link io.netty.channel.Channel}
     */
