...
/**
 * {@link io.netty.channel.ChannelInboundHandlerAdapter} which decodes from one message to an other message.
 *
 *
 ...
 *             {@link io.netty.handler.codec.MessageToMessageDecoder}&lt;{@link String}&gt; {
 *
 *         {@code @Override}
 *         public void decode({@link io.netty.channel.ChannelHandlerContext} ctx, {@link String} message,
 ...
 * are of type {@link io.netty.util.ReferenceCounted}. This is needed as the {@link io.netty.handler.codec.MessageToMessageDecoder} will call
