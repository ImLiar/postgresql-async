...
/**
 * Decompress a {@link io.netty.buffer.ByteBuf} using the inflate algorithm.
 */
public class JdkZlibDecoder extends ZlibDecoder {
    ...
    /**
     * Creates a new instance with the default wrapper ({@link io.netty.handler.codec.compression.ZlibWrapper#ZLIB}).
     */
     ...
     * is always {@link io.netty.handler.codec.compression.ZlibWrapper#ZLIB} because it is the only format that
     ...
     * Be aware that only {@link io.netty.handler.codec.compression.ZlibWrapper#GZIP}, {@link io.netty.handler.codec.compression.ZlibWrapper#ZLIB} and {@link io.netty.handler.codec.compression.ZlibWrapper#NONE} are
     * supported atm.
     */
