...
/**
 * {@link io.netty.channel.ChannelOutboundHandlerAdapter} which encodes from one message to an other message
 *
 * For example here is an implementation which decodes an {@link Integer} to an {@link String}.
 *
 * <pre>
 *     public class IntegerToStringEncoder extends
 *             {@link io.netty.handler.codec.MessageToMessageEncoder}&lt;{@link Integer}&gt; {
 *
 *         {@code @Override}
 *         public void encode({@link io.netty.channel.ChannelHandlerContext} ctx, {@link Integer} message, List&lt;Object&gt; out)
 ...
 * are of type {@link io.netty.util.ReferenceCounted}. This is needed as the {@link io.netty.handler.codec.MessageToMessageEncoder} will call
